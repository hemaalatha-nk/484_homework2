...
function Landing() {
    ...
    const uniqueTitles = [
        ...new Set(previousChats.map((element) => element.title)),
    ];
          ...
          */}
            ...
            <section className="main">
                ...
                <div className="bottom-section">
                    ...
                    <p className="info">
                        Fun to love GPT App for showing a Full-stack
                        application. Allows to demo a 301 Full-stack
                        Application.
                    </p>
                </div>
            </section>
