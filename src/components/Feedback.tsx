...
function FeedbackScreen() {
    ...
    const [data, setData] = useState<Array<FormData>>([
        {
            name: "Crish",
            emailId: "crish4@uic.edu",
            ldescription: "Schema",
            sdescription:
                "The existing colo schema cam be made more attractive.",
        },
        {
            name: "Hema",
            emailId: "hning4@uic.edu",
            ldescription: "UI",
            sdescription: "Submit button is not rendering properly.",
        },
        {
            name: "Jhon",
            emailId: "jhon4@uic.edu",
            ldescription: "Features Request",
            sdescription: "Make it easy.",
        },
    ]);
